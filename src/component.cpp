...
#include <rmcs_navigation/msg/game_status.hpp>
...
public:
        ...
        : Node("rmcs_navigation")
    {
        ...
        status_publisher_ = create_publisher<msg::GameStatus>("/rmcs_navigation/status", 5);
    }

    void update() override
    {
        static auto update_count = 0;
        static rmcs_navigation::msg::GameStatus status;
...
private:
    std::shared_ptr<rclcpp::Publisher<rmcs_navigation::msg::GameStatus>> status_publisher_;
    ...
    inline void publish_status(const rmcs_navigation::msg::GameStatus& status)
    {
        status_publisher_->publish(status);
    }

    void collect_referee_message(rmcs_navigation::msg::GameStatus& status)
    {
        // the hp of friends
    ...
    void collect_auto_aim_message(rmcs_navigation::msg::GameStatus& status)
    {
        // the pose of enemies
...
PLUGINLIB_EXPORT_CLASS(rmcs_navigation::Component, rmcs_executor::Component)